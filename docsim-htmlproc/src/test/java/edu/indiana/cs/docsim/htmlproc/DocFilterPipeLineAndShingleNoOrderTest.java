...
public class DocFilterPipeLineAndShingleNoOrderTest
  extends TestCase {
    private static Logger logger =
        Logger.getLogger(DocFilterPipeLineAndShingleNoOrderTest.class.getName());
     ...
     */
    public DocFilterPipeLineAndShingleNoOrderTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(DocFilterPipeLineAndShingleNoOrderTest.class);
    }
